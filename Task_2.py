...
def main():
  ...
  if (ay=="March" and (gun>=20 and gun<=31)) or (ay=="June" and gun<21) or (ay=="May" or ay=="April"):
      ...
      print()
  elif ((ay=="September") and (gun>=22 and gun<=31)) or ((ay=="December" and gun<21) or (ay=="October" or ay=="November")):
      print(f"{ay} {gun} is in Fall")
      print()
  elif ((ay=="December") and (gun>=21 and gun<=31)) or (ay=="March" and gun<20) or (ay=="January" or ay=="February"):
